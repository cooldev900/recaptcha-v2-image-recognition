...
PHONE_NUMBER_POSITION = env.int('PHONE_NUMBER_POSITION')
REPLACE_POSITIONS = env.str('REPLACE_POSITIONS')
MESSAGE_HISTORY_URL = env.str('MESSAGE_HISTORY_URL')

FIRST_NAME_POSITION = env.str('FIRST_NAME_POSITION')
LAST_NAME_POSITION = env.str('LAST_NAME_POSITION')
COMPANY_NAME_POSITION = env.str('COMPANY_NAME_POSITION')
TITLE_POSITION = env.str('TITLE_POSITION')
EMAIL_ADDRESS_POSITION = env.str('EMAIL_ADDRESS_POSITION')
STREET_ADDRESS_POSITION = env.str('STREET_ADDRESS_POSITION')
CITY_POSITION = env.str('CITY_POSITION')
STATE_POSITION = env.str('STATE_POSITION')
ZIP_CODE_POSITION = env.str('ZIP_CODE_POSITION')
COUNTRY_POSITION = env.str('COUNTRY_POSITION')
